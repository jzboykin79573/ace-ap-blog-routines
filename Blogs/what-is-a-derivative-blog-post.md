...
Here is the truth: there are exactly 3 limit definitions of the derivative. Most students only learn 1, if not any! However, the AP exam uses all 3. And if you know all 3 cold, you will recognize that limit immediately and know exactly what to do. In multiple choice, that recognition is worth an automatic point and takes under 60 seconds.

Most students learn derivatives through basic memorization - you know, just know the formulas. But I believe you should know the concepts first, because that is what AP graders actually expect. In my experience, that order is the difference between a student who gets a 3 and my students who score 5s.

This is not a quick read. But 12 minutes here will save you hours of confusion later in your course.

By the time we are done, you will know what a derivative means conceptually, you will have all 3 limit definitions locked in, and you will be able to handle the problem type where the AP exam gives you the limit and asks you to identify the function. And just so you know - this shows up every single year on the AP exam in some form. Expect it.
...
And here is the truth: if you cannot say that definition out loud without looking at your notes, you are not ready for the exam. I have seen students who could do the algebra perfectly but could not explain what a derivative is in one sentence. That is the gap that costs you points on every problem that asks you to connect the concept to the calculation.
...
[ADDED FOR CLARITY - not in original lecture: The AP exam will sometimes tell you which form to use. But for "identify the function" problems, you need to recognize the form yourself first. That recognition is the skill.]
...
[Get the Free Guide - aceapcalculus.com/before-apcalc]
...
[Download the Free Guide - aceapcalculus.com/before-apcalc]
